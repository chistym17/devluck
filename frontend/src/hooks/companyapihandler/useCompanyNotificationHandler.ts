...
interface UseCompanyNotificationHandlerReturn {
...
export const useCompanyNotificationHandler = (): UseCompanyNotificationHandlerReturn => {
  ...
  const markAsRead = useCallback(async (id: string): Promise<void> => {
    ...
    setError(null)
    try {
      await api.put(`/api/company/notifications/${id}/read`)
  ...
  const markAllAsRead = useCallback(async (): Promise<void> => {
    ...
    setError(null)
    try {
      await api.put('/api/company/notifications/read-all')
